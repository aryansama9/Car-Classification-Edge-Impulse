...
const ei_impulse_t impulse_503035_0 = {
    .project_id = 503035,
    .project_owner = "aryan sama",
    .project_name = "Assessment 3, classification",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 9,

    .nn_input_frame_size = 1370928,
    .raw_sample_count = 456976,
    .raw_samples_per_frame = 1,
    .dsp_input_frame_size = 456976 * 1,
    .input_width = 676,
    .input_height = 676,
    .input_frames = 1,
    .interval_ms = 1,
    ...
    .visual_ad_grid_size_x = int((676 / 8) / 2 - 1),
    .visual_ad_grid_size_y = int((676 / 8) / 2 - 1),
    
    .tflite_output_features_count = 14450,
...
ei_impulse_handle_t impulse_handle_503035_0 = ei_impulse_handle_t( &impulse_503035_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_503035_0;
